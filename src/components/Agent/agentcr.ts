    ...
    inventory: {
      ...
      disks: [
        {
          ...
          serial: '20120731-1',
          smart:
            '{"json_format_version":[1,0],"smartctl":{"version":[7,1],"svn_revision":"5022","platform_info":"x86_64-linux-4.18.0-240.15.1.el8_3.x86_64","build_info":"(local build)","argv":["smartctl","--xall","--json=c","/dev/sda"],"messages":[{"string":"/dev/sda: Unknown USB bridge [0x0624:0x0251 (0x000)]","severity":"error"}],"exit_status":1}}',
          vendor: 'iDRAC',
        },
        {
          bootable: true,
      ...
      interfaces: [
        ...
        },
        {
          ...
          hasCarrier: true,
          ipV4Addresses: [],
          ipV6Addresses: ['2620:52:0:1303::6/64', '2620:52:0:1303:8058:2bde:661d:51f/64'],
